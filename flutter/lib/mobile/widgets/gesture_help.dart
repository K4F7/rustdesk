                ...
                Container(
                  ...
                  children: _touchMode
                      ? [
                          ...
                          GestureInfo(
                              width,
                              GestureIcons.iconGesturePress,
                              translate("One-Long Press"),
                              translate("Right Mouse")),
                          GestureInfo(
                              width,
                              GestureIcons.iconGestureFSwipeRight,
                              translate("One-Finger Quick Drag"),
                              translate("Left Drag")),
                          GestureInfo(
                              width,
                              GestureIcons.iconGesturePressHold,
                              translate("One-Long Press & Drag"),
                              translate("Right Drag")),
                          GestureInfo(
                              width,
                              GestureIcons.iconGestureFDragUpDown_,
                              translate("Two-Finger Same Direction"),
                              translate("Mouse Wheel (Down = Wheel Up)")),
                          GestureInfo(
                              width,
                              GestureIcons.iconGesturePinch,
                              translate("Two-Finger Opposite Direction"),
                              translate("Ctrl + Mouse Wheel")),
                        ]
                      : [
                          GestureInfo(
                              width,
